  ...
  return (
    <section className="relative w-full" id="about">
      ...
      <div className="mx-auto flex flex-col-reverse lg:flex-row items-center w-full max-w-[1200px] lg:justify-between">
        {/* Left Side */}
        <img src="./images/Splash.png" alt="HackTX 2025 Logo" className="select-none" draggable={false} />
        ...
        <div className="mt-24 mb-8 flex flex-col justify-center items-center lg:items-end text-center lg:text-right">
          ...
          <div className="text-white mt-0.5 text-sm lg:text-lg">
            ...
            <a href="https://rodeo.freetailhackers.com/" className="underline whitespace-nowrap">
              Apply here
            </a>
            <br />
            Interested in sponsoring us?{" "}
            <a href="mailto:corporate@freetailhackers.com" className="underline whitespace-nowrap">
              Learn more
            </a>
          </div>
          <a
      ...
      <div className="relative">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between gap-8 lg:gap-12 mb-10 lg:mb-14 items-center lg:items-start">
            ...
            <div className="flex flex-col text-white max-w-[600px] lg:mt-12 text-center lg:text-left">
              <p className="text-base mb-6">
                With the best and the brightest of hackers from across the country coming to Austin, teams
                work together to find new tech solutions to important issues.
              </p>
              <p className="text-base">
                Join us for HackTX 2025, and be part of an innovative tech tradition, where we've hosted over
                5000+ participants and $100K+ in prizes across over a decades worth of HackTXs, with much more
                to come this year!
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between gap-8 lg:gap-12 items-center lg:items-start">
            ...
            <div className="text-white max-w-[450px] text-center lg:text-left">
              <p className="text-2xl">
                HackTX is a 36 hour event where tech enthusiasts can come together to create something amazing
                together!
              </p>
            </div>
            ...
            <div className="relative w-full flex flex-col lg:mt-8 gap-8 lg:gap-0 items-center max-lg:px-[10%]">
              <div className="relative text-center self-end mb-0 lg:mb-12">
                <img
                  src="./images/5000 Constellation.png"
                  alt="5000 Constellation"
                  draggable={false}
                  className="absolute -top-[30px] -right-[60px]"
                />
                <div className="font-serif text-5xl lg:text-6xl text-white">5000+</div>
                <div className="text-base text-white">participants</div>
              </div>
              <div className="relative text-center self-start">
                <img
                  src="./images/100K Constellation.png"
                  alt="100K Constellation"
                  draggable={false}
                  className="absolute -top-[60px] -left-[30px]"
                />
                <div className="font-serif text-5xl lg:text-6xl text-white">$100K+</div>
        ...
        <div className="absolute -right-[100px] -top-[200px] w-[1523px] h-[1051px] -z-10">
          <img src="./images/Stats Nebula.png" alt="Background" draggable={false} />
        </div>
      ...
      <div className="relative mx-auto flex flex-col items-center text-center w-full max-w-[1200px] pt-40 lg:pt-56">
        <div className="absolute -top-[25vw] max-w-[1680px] max-h-[1066px] w-[120vw] -z-10">
          <img src="./vectors/About Lines.svg" alt="Background" draggable={false} />
        </div>
        ...
        <p className="text-white max-sm:text-sm max-w-[720px] text-center">
          For over a decade, Freetail Hackers has been hosting the premier UT Austin hackathon, HackTX. With a
          team of over 40 members organizing tirelessly across six teams, we always have exceptional events
          that foster creativity, innovation, and collaboration, while pushing the boundaries of tech and
          learning!
        </p>
        <img
        ...
        <div className="absolute -left-[700px] top-0 w-[1523px] h-[1051px] -z-10">
          <img src="./images/Whale Nebula.png" alt="Whale nebula" draggable={false} />
        </div>
      </div>
    </section>
  );
