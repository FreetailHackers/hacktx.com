...
export default function MobileLanding() {
  return (
    <div className="relative">
      ...
      <AnimatedLogo className="absolute left-1/2 -translate-x-1/2" style={{ top: "4%", width: "90vw" }} />
      ...
      <a
        ...
        style={{ top: "70%", left: "28%", width: "26.2vw", zIndex: 10 }}
      >
      ...
      <a
        ...
        rel="noopener noreferrer"
        className="absolute transition-transform duration-200 hover:scale-110 hover:brightness-110"
        style={{ top: "67%", left: "44%", width: "52vw" }}
      >
