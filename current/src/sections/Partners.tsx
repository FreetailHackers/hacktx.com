  ...
  return (
    <section className="relative my-20 max-w-5xl mx-auto" id="partners">
      ...
      <div className="text-white mb-16">
        <h2 className="font-serif text-lg md:text-4xl font-bold text-center mb-2">
          a big thank you to our
        </h2>
        <h2 className="font-serif text-2xl md:text-5xl font-semibold text-center mb-4">
          amazing partners
        </h2>
        <p className="text-center text-sm md:text-lg">
          Want to join our constellation of partners?
        </p>
      ...
      <div>
        <div className="flex flex-wrap gap-8 justify-center">
          <a
            href="https://northmarkstrategies.com/"
            target="_blank"
